...
public class PlayState extends FlxState {
    ...
    public void create() {
        ...
        crateStorm = new FlxButton(2, FlxG.height - 22, "Crate Storm", new IFlxButton() {
            @Override
        ...
        add(crateStorm);
        flxRiderButton = new FlxButton(82, FlxG.height - 22, "Flixel Rider", new IFlxButton() {
            @Override
            public void callback() {
                onFlixelRider();
            }
        ...
        add(flxRiderButton);
        crateStormG1 = new FlxButton(162, FlxG.height - 22, "Blue Group", new IFlxButton() {
            @Override
            public void callback() {
                onBlue();
            }
        ...
        add(crateStormG1);
        crateStormG2 = new FlxButton(242, FlxG.height - 22, "Red Group", new IFlxButton() {
            @Override
            public void callback() {
                onRed();
            }
        ...
        add(crateStormG2);
        groupCollision = new FlxButton(320, FlxG.height - 22, "Collide Groups", new IFlxButton() {
            @Override
            public void callback() {
                onCollideGroups();
            }
