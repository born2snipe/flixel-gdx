...
public class MenuState extends FlxState {
    ...
    public void update() {
        ...
        if (title2.x > title1.x + title1.width - 4) {
            ...
            FlxButton flixelButton = new FlxButton(FlxG.width / 2 - 40, FlxG.height / 3 + 54, "flixel.org", new IFlxButton() {
                @Override
            ...
            FlxButton dannyButton = new FlxButton(flixelButton.x, flixelButton.y + 22, "music: dannyB", new IFlxButton() {
                @Override
                public void callback() {
                    onDanny();
                }
            ...
            playButton = new FlxButton(flixelButton.x, flixelButton.y + 82, "CLICK HERE", new IFlxButton() {
                @Override
                public void callback() {
                    onPlay();
                }
        ...
        if (!fading
            ...
            FlxG.play(SndHit2);
            FlxG.flash(0xffd8eba2, 0.5f);
            FlxG.fade(0xff131c1b, 1, new IFlxCamera() {
                @Override
                public void callback() {
                    onFade();
                }
    ...
    protected void onFade() {
		if (attractMode) {
			FlxG.loadReplay((FlxG.random() < 0.5f) ? FlxG.loadString(Attract1) : FlxG.loadString(Attract2), new PlayState(), new String[]{"ANY"}, 22, new IFlxReplay() {
				@Override
				public void callback() {
					onDemoComplete();
				}
