...
public class PlayState extends FlxState {
    ...
    public void update() {
        ...
        FlxG.overlap(_hazards, _player, new IFlxCollision() {
            @Override
            public void callback(FlxObject Object1, FlxObject Object2) {
                overlapped(Object1, Object2);
            }
        });
        FlxG.overlap(_bullets, _hazards, new IFlxCollision() {
            @Override
            public void callback(FlxObject Object1, FlxObject Object2) {
                overlapped(Object1, Object2);
            }
        ...
        if (!_fading) {
            ...
            if (_spawners.countLiving() <= 0) {
                _fading = true;
                FlxG.fade(0xffd8eba2, 3, new IFlxCamera() {
                    @Override
