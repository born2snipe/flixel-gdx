...
public class PlayState extends FlxState {
    ...
    public void create() {
        ...
        _btnFindPath = new FlxButton(320, 10, "Move To Goal", new IFlxButton() {
            @Override
        ...
        _btnStopUnit = new FlxButton(320, 30, "Stop Unit", new IFlxButton() {
            @Override
            public void callback() {
                stopUnit();
            }
        ...
        _btnResetUnit = new FlxButton(320, 50, "Reset Unit", new IFlxButton() {
            @Override
            public void callback() {
                resetUnit();
            }
