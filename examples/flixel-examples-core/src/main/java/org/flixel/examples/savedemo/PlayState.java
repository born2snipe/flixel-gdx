...
public class PlayState extends FlxState {
    ...
    public void create() {
        ...
        demoSave = new FlxButton(2, FlxG.height - 22, "Save Locations", new IFlxButton() {
            @Override
        ...
        add(demoSave);
        demoLoad = new FlxButton(82, FlxG.height - 22, "Load Locations", new IFlxButton() {
            @Override
            public void callback() {
                onLoad();
            }
        ...
        add(demoLoad);
        demoClear = new FlxButton(202, FlxG.height - 22, "Clear Save", new IFlxButton() {
            @Override
            public void callback() {
                onClear();
            }
